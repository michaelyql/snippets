...
A **pack** is just "zero or more things". The "things" can be types, values, templates, function parameters, lambda captures, etc.
...
## Relevant Articles
- [Rules for the ... token in variadic templates - Stackoverflow](https://stackoverflow.com/questions/17652412/what-are-the-rules-for-the-token-in-the-context-of-variadic-templates)
