---
description: Linked list, ring buffers and their applications
---
...
```cpp title="SPSCQueue.h" showLineNumbers
#pragma once
...
[^2]: [\[GitHub source\]](https://github.com/rigtorp/SPSCQueue/blob/master/include/rigtorp/SPSCQueue.h),  [\[Rigtorp: Optimizing a ring buffer for throughput
\]](https://rigtorp.se/ringbuffer/)
[^3]: https://kmdreko.github.io/posts/20191003/a-simple-lock-free-ring-buffer/
